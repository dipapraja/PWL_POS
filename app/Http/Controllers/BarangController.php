...
class BarangController extends Controller
{
    ...
    public function export_excel()
    {
        ...
        foreach ($barang as $key => $value) {
            ...
            $sheet->setCellValue('A'.$baris, $value->barang_nama);
            $sheet->setCellValue('A'.$baris, $value->harga_beli);
            $sheet->setCellValue('A'.$baris, $value->harga_jual);
            $sheet->setCellValue('A'.$baris, $value->kategori->kategori_nama); // ambil nama kategori
            $baris++;
            $no++;
        }
